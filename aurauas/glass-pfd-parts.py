...
try:
	...
	a.translate(-100+6.25, 100-6.25).begin()
	...
	a.translate(-100+6.25, 100-15.25).begin()
	...
	a.translate(-100+62.5, 100-10.25).begin()
	...
	a.translate(-100+115.625, 100-9.375).begin()
	...
	a.translate(-100+143.75, 100-1.5625).begin()
	...
	a.translate(-100+18.75, 100-18.75).begin()
	...
	a.translate(-100+31.25, 100-18.75).begin()
